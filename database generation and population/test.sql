...
-- products
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (1, '8435', 'sit', 'diam', 4, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (2, '9352', 'mollis', 'ultrices enim lorem ipsum', 9, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (3, '7019', 'potenti', 'fusce consequat nulla nisl nunc nisl duis bibendum felis sed', 3, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (4, '1552', 'nibh', 'aliquam convallis nunc proin at turpis a pede posuere nonummy integer non velit donec diam neque vestibulum', 6, 22, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (5, '4867', 'quis', 'vel est donec odio justo sollicitudin ut suscipit a feugiat et eros vestibulum ac est lacinia nisi venenatis tristique', 7, 35, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (6, '1607', 'orci', 'dis parturient', 2, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (7, '1570', 'interdum', 'mi integer ac neque duis bibendum', 2, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (8, '2546', 'risus', 'congue', 8, 90, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (9, '6601', 'quis', 'hac habitasse platea dictumst maecenas ut massa quis augue luctus tincidunt nulla mollis molestie lorem quisque ut', 5, 95, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (10, '6522', 'ut', 'rutrum neque aenean', 4, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (11, '5645', 'dignissim', 'ante vel ipsum praesent blandit lacinia erat vestibulum sed magna at nunc', 1, 69, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (12, '0966', 'tempus', 'morbi non lectus aliquam sit amet diam in magna bibendum imperdiet nullam orci pede venenatis non sodales sed', 3, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (13, '4646', 'quam', 'faucibus orci luctus et ultrices posuere cubilia curae mauris viverra diam vitae quam suspendisse potenti nullam', 4, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (14, '4350', 'interdum', 'enim lorem ipsum dolor sit amet consectetuer adipiscing elit proin interdum mauris non ligula', 2, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (15, '7158', 'phasellus', 'eros elementum pellentesque quisque porta volutpat erat quisque', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (16, '2485', 'odio', 'velit vivamus vel nulla eget eros elementum pellentesque quisque porta volutpat erat quisque erat eros viverra eget congue eget semper', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (17, '1943', 'fusce', 'varius integer ac leo pellentesque ultrices mattis odio donec vitae nisi', 7, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (18, '7028', 'lacinia', 'odio donec', 6, 3, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (19, '6856', 'cras', 'mattis nibh ligula nec sem duis aliquam convallis nunc proin at turpis a pede', 9, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (20, '7264', 'adipiscing', 'morbi quis tortor id nulla ultrices aliquet maecenas leo odio condimentum', 7, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (21, '5685', 'interdum', 'vestibulum rutrum rutrum neque aenean auctor gravida sem praesent id massa id nisl venenatis lacinia aenean sit amet justo morbi', 3, 63, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (22, '3055', 'et', 'non mi integer ac neque duis bibendum morbi non', 5, 42, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (23, '8428', 'lorem', 'mauris lacinia sapien quis libero nullam sit amet turpis elementum ligula vehicula', 2, 34, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (24, '9628', 'sed', 'enim lorem ipsum dolor sit amet consectetuer adipiscing elit proin interdum mauris non', 5, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (25, '8913', 'vivamus', 'felis sed interdum venenatis turpis enim blandit mi in porttitor pede justo eu massa donec dapibus duis at', 4, 89, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (26, '1098', 'maecenas', 'ipsum primis in faucibus orci luctus et ultrices posuere', 1, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (27, '8878', 'consequat', 'venenatis tristique fusce congue diam id ornare imperdiet sapien urna pretium nisl ut volutpat sapien arcu sed augue aliquam erat', 4, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (28, '3531', 'vestibulum', 'in ante vestibulum ante ipsum primis in', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (29, '9713', 'rutrum', 'sociis natoque penatibus et magnis dis', 5, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (30, '4893', 'nam', 'convallis morbi odio odio elementum', 8, 55, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (31, '8706', 'erat', 'ut rhoncus aliquet pulvinar sed nisl nunc rhoncus dui', 7, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (32, '3524', 'nam', 'felis fusce posuere felis sed lacus morbi sem mauris laoreet ut rhoncus', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (33, '1665', 'fusce', 'est', 9, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (34, '1356', 'ante', 'donec vitae', 1, 90, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (35, '6600', 'at', 'sodales', 2, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (36, '4512', 'id', 'ultrices libero non mattis pulvinar nulla pede ullamcorper augue a suscipit nulla elit ac nulla sed vel enim sit amet', 9, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (37, '5370', 'nulla', 'potenti in eleifend quam a odio', 8, 35, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (38, '5526', 'consequat', 'nibh in quis justo maecenas rhoncus aliquam lacus morbi quis tortor id nulla ultrices aliquet maecenas leo odio condimentum', 3, 66, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (39, '1790', 'in', 'id pretium iaculis diam erat fermentum justo nec condimentum neque sapien placerat ante nulla justo', 9, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (40, '2817', 'pharetra', 'at feugiat non pretium quis lectus suspendisse potenti', 5, 95, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (41, '5842', 'dui', 'ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae mauris viverra diam vitae quam', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (42, '5221', 'sit', 'sit amet consectetuer adipiscing elit proin interdum mauris non ligula pellentesque ultrices phasellus', 5, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (43, '6927', 'odio', 'eros viverra eget congue eget semper rutrum nulla nunc purus phasellus in', 5, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (44, '8231', 'sem', 'eget tincidunt eget tempus vel pede morbi porttitor lorem id ligula suspendisse', 7, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (45, '6893', 'ultricies', 'integer ac leo pellentesque ultrices mattis odio donec vitae', 2, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (46, '8839', 'porta', 'nulla neque', 8, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (47, '8842', 'leo', 'venenatis turpis enim blandit mi in porttitor pede justo', 6, 72, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (48, '6580', 'nec', 'pellentesque quisque porta', 9, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (49, '3843', 'congue', 'congue vivamus metus arcu adipiscing molestie hendrerit', 3, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (50, '1980', 'libero', 'ante ipsum', 2, 74, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (51, '9029', 'est', 'non mi integer ac neque duis bibendum morbi non', 8, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (52, '7707', 'ut', 'parturient montes nascetur ridiculus mus', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (53, '1999', 'feugiat', 'sem praesent id massa id nisl venenatis lacinia aenean sit amet justo', 7, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (54, '7927', 'sed', 'ipsum ac tellus semper interdum mauris ullamcorper purus sit amet nulla quisque arcu', 1, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (55, '7213', 'convallis', 'in quis justo maecenas rhoncus aliquam lacus morbi quis tortor id nulla ultrices', 1, 8, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (56, '3411', 'condimentum', 'convallis morbi odio odio elementum eu interdum eu tincidunt in leo maecenas pulvinar lobortis', 3, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (57, '0833', 'fusce', 'lacus curabitur at ipsum', 6, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (58, '3394', 'ipsum', 'varius nulla facilisi cras non velit nec', 9, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (59, '8445', 'quam', 'cubilia curae donec pharetra magna vestibulum aliquet', 6, 38, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (60, '5377', 'donec', 'et', 6, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (61, '6045', 'sem', 'metus vitae ipsum aliquam non mauris morbi non lectus aliquam sit amet', 4, 94, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (62, '4781', 'in', 'ridiculus mus vivamus vestibulum sagittis sapien', 8, 1, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (63, '1991', 'tortor', 'tempor convallis', 3, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (64, '9419', 'quis', 'augue vestibulum rutrum rutrum neque aenean auctor gravida sem praesent id massa id nisl venenatis', 1, 85, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (65, '6133', 'lorem', 'justo maecenas rhoncus aliquam lacus morbi quis tortor id nulla ultrices', 9, 55, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (66, '5708', 'id', 'fringilla rhoncus mauris enim leo rhoncus sed vestibulum sit amet cursus id turpis', 4, 37, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (67, '2024', 'quam', 'dui vel nisl duis ac nibh fusce lacus purus aliquet at feugiat non pretium quis', 5, 1, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (68, '1437', 'pulvinar', 'venenatis non sodales sed tincidunt eu felis fusce posuere felis', 9, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (69, '5670', 'adipiscing', 'consequat ut nulla sed accumsan felis ut at dolor quis', 9, 89, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (70, '7900', 'in', 'ut tellus nulla ut erat id mauris vulputate elementum nullam varius nulla facilisi cras non velit nec nisi vulputate', 7, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (71, '7729', 'nam', 'mi in porttitor pede justo eu massa donec', 6, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (72, '1549', 'ac', 'aliquam convallis nunc proin at turpis a pede posuere nonummy integer non velit donec diam neque', 6, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (73, '2870', 'ac', 'ante vestibulum ante ipsum primis', 7, 1, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (74, '6002', 'non', 'mus vivamus vestibulum sagittis sapien cum sociis natoque penatibus', 3, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (75, '9940', 'nulla', 'eget tincidunt eget tempus vel pede morbi porttitor lorem id ligula suspendisse ornare consequat lectus in est risus auctor', 1, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (76, '3806', 'magnis', 'vel nisl duis ac nibh fusce lacus purus aliquet at feugiat', 8, 63, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (77, '6532', 'dictumst', 'turpis eget elit', 8, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (78, '8211', 'est', 'adipiscing lorem vitae mattis nibh ligula nec sem duis', 2, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (79, '2512', 'diam', 'vel augue vestibulum rutrum rutrum neque aenean auctor', 2, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (80, '4607', 'enim', 'cubilia curae donec pharetra magna vestibulum aliquet ultrices erat tortor sollicitudin mi sit amet lobortis sapien sapien non mi integer', 2, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (81, '4663', 'vestibulum', 'ac neque duis bibendum morbi non quam nec dui luctus', 9, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (82, '7033', 'aliquet', 'congue risus semper porta volutpat quam pede lobortis ligula sit', 6, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (83, '7316', 'donec', 'ac nulla sed vel enim sit amet', 1, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (84, '4693', 'semper', 'eget rutrum at lorem integer tincidunt ante vel ipsum praesent', 8, 24, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (85, '7303', 'fringilla', 'convallis nulla neque libero convallis eget eleifend luctus ultricies eu nibh', 2, 30, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (86, '0445', 'turpis', 'porta volutpat quam pede lobortis ligula sit amet eleifend pede libero quis orci nullam molestie', 8, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (87, '9766', 'tortor', 'justo sit amet sapien dignissim vestibulum vestibulum ante ipsum primis in faucibus orci luctus et', 5, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (88, '2092', 'id', 'eleifend luctus ultricies eu nibh quisque id justo', 2, 12, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (89, '9204', 'parturient', 'porta volutpat erat quisque erat eros', 4, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (90, '7505', 'purus', 'massa volutpat convallis', 5, 92, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (91, '8919', 'sapien', 'pede venenatis non sodales', 2, 13, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (92, '5766', 'lacus', 'libero ut massa volutpat convallis morbi odio odio elementum eu interdum', 3, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (93, '7957', 'nunc', 'ultrices posuere cubilia curae mauris viverra diam vitae quam', 5, 1, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (94, '3291', 'enim', 'at lorem integer tincidunt ante vel ipsum praesent', 4, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (95, '1633', 'integer', 'enim in tempor turpis nec euismod scelerisque quam turpis adipiscing lorem vitae mattis', 3, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (96, '4715', 'convallis', 'diam id ornare imperdiet sapien urna pretium nisl ut volutpat sapien arcu sed augue aliquam erat volutpat in congue', 7, 23, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (97, '2022', 'semper', 'rutrum neque aenean auctor gravida sem praesent id massa id nisl', 6, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (98, '7409', 'venenatis', 'habitasse platea dictumst maecenas', 1, null, 'In stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (99, '8345', 'justo', 'convallis nunc proin at turpis a pede posuere nonummy integer non velit donec diam neque', 7, null, 'Out of stock');
insert into Product (product_id, price, name, description, category_id, cart_id, status) values (100, '1988', 'semper', 'ipsum integer a nibh in quis', 5, null, 'In stock');
